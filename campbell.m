...
%*                          Campbell.f                            
%*     
%*    Calculates the Leaf Angle Distribution (LAD) function value (freq) 
%*    using an ellipsoidal distribution model characterized by the average 
%*    leaf inclination angle (ala), expressed in degrees.                                     
