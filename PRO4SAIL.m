function [rdot,rsot,rddt,rsdt]=PRO4SAIL(N,Cab,Car,Cbrown,Cw,Cm,LIDFa,LIDFb,TypeLidf,lai,q,tts,tto,psi,rsoil,Cdust)

%==========================================================================
% PRO4SAIL Model Implementation
%
% This version was implemented by Jean-Baptiste FERET,
% who assumes full responsibility for this implementation.
%
% Author contact:
% Jean-Baptiste FERET
...
%
% PRO4SAIL is based on the original SAILH model developed by Wout Verhoef (NLR, 2003),
% and available at: http://teledetection.ipgp.jussieu.fr/prosail/
%
% The PRO4SAIL model provides improvements to SAILH by avoiding numerical singularities
% and increasing computational efficiency when fewer parameters vary.
%
% Reference:
% Verhoef et al. (2007), Unified Optical-Thermal Four-Stream Radiative Transfer Theory
% for Homogeneous Vegetation Canopies, IEEE Transactions on Geoscience and Remote Sensing,
% Vol. 45, No. 6, June 2007.
%
% Note:
% The module "staticvar" stores static variables between successive function calls.
% If vertical flux profiles inside the canopy are required, variables such as m, sb,
% sf, ks, and rinf must be accessible from the calling routine, necessitating declaration
% of this module in that context.
%==========================================================================
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
LRT=prospect_DR(N,Cab,Car,Cbrown,Cw,Cm,Cdust);
rho	=	LRT(:,2);
tau	=	LRT(:,3);
figure,hold on
plot(LRT(:,1),LRT(:,2))
